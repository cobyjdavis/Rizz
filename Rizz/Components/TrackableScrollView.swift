...
struct TrackableScrollView<Content>: View where Content: View {
    ...
    init(_ axes: Axis.Set = .vertical, showIndicators: Bool = true, contentOffset: Binding<CGFloat>, contentHeight: Binding<CGFloat>, @ViewBuilder content: () -> Content) {
        self.axes = axes
                ...
                ZStack(alignment: self.axes == .vertical ? .top : .leading) {
                    GeometryReader { insideProxy in
                        Color.clear
                            ...
                            .onAppear {
                                self.contentHeight = calculateContentHeight(fromOutsideProxy: outsideProxy, insideProxy: insideProxy)
                                print(contentHeight)
                            }
                    }
                    VStack {
    ...
    private func calculateContentHeight(fromOutsideProxy outsideProxy: GeometryProxy, insideProxy: GeometryProxy) -> CGFloat {
